...
import 'package:auth/signinwithemail.dart';
import 'package:auth/accountcreate.dart';
        ...
        builder: (context) => Stack(
          ...
          children: <Widget>[
            Container(
              ...
              child: Image.asset("assets/batmans.png",fit: BoxFit.fill,
              ),
            ),
            Column(
                ...
                Container(
                    ...
                    child: Align(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>signinwithemail()));
                        },
                      ),
                    )
                ),
                Container(
                    ...
                    child: Align(
                      ...
                      child: FlatButton(
                        ...
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>accountcreate()));
                        },
                      ),
                    )
                )
